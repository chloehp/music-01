...
const instrumentSwitch = [
  {t : "Synth", x : new Tone.PolySynth(Tone.Synth).toDestination()},
  {t : "DuoSynth", x : new Tone.PolySynth(Tone.DuoSynth).toDestination()},
  {t : "FMSynth", x : new Tone.PolySynth(Tone.FMSynth).toDestination()},
  {t : "MonoSynth", x : new Tone.PolySynth(Tone.MonoSynth).toDestination()},
  {t : "AMSynth", x : new Tone.PolySynth(Tone.AMSynth).toDestination()},
  {t : "Piano", x : new Tone.Sampler({
